 ...
 */
public class Video_freg extends Fragment {
    View view;
    RecyclerView recycler_video;
    private List<Video_Model> video_model = new ArrayList<Video_Model>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_video_freg, container, false);
        ...
        video_adapter = new Video_Adapter(getActivity(), video_model);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());

        recycler_video.setLayoutManager(mLayoutManager);
        ...
        recycler_video.setAdapter(video_adapter);
    ...
    private void CALL_Directory_API() {
        for(int i=0;i<10;i++)
        {
            video_model.add(new Video_Model("","",""));
...
/*
    ...
    private void AllocateMemory(View view) {
        ...
        progressBar_video = view.findViewById(R.id.progressBar_video);
